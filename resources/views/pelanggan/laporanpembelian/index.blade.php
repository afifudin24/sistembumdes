...
<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Rekap Riwayat Pembelian</h1>
...
@endif
    ...
    <div class="col-sm-4 d-flex gap-2">
        ...
        <a href="{{ route('rekapriwayatpembelian') }}" class="btn  btn-secondary">Reset</a>
         <a href="{{ route('eksporriwayatpembelian', request()->all()) }}" target="_blank" class="btn  btn-success">
            Ekspor PDF
        </a>
    </div>
</form>
