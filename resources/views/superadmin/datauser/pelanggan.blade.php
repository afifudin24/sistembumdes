...
@endif
										...
										<tr>
                                         ...
                                         <td class="d-none d-xl-table-cell text-capitalize ">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <a class="btn btn-success mt-2" href="/aktifkanpelanggan/{{$item->pelanggan_id}}">Aktifkan</a>
                                            </div>
</td>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form id="tambahpelanggan" action="{{ route('tambahpelanggan') }}" method="POST">
        @csrf
        <div class="modal-header">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form id="formHapuspelanggan" method="POST">
        ...
        <div class="modal-body">
          <p>Apakah Anda yakin ingin menghapus  pelanggan <strong id="namaHapus"></strong>?</p>
        </div>
        <div class="modal-footer">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnEdit').on('click', function() {
                ...
                $('#editpelanggan').attr('action', '/updatepelanggan/' + item.pelanggan_id);
            });
        });
      ...
      // Set action form
      $('#formHapuspelanggan').attr('action', '/hapuspelanggan/' + item.pelanggan_id);
    });
    </script>
